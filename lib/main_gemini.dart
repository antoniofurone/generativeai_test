import 'package:generativeai_test/secrets/api_key.dart';

import './gemini/sections/chat.dart';
import './gemini/sections/embed_batch_contents.dart';
import './gemini/sections/embed_content.dart';
import './gemini/sections/response_widget_stream.dart';
import './gemini/sections/stream.dart';
import './gemini/sections/text_and_image.dart';
import './gemini/sections/text_only.dart';
import 'package:flutter/material.dart';
import 'package:flutter_gemini/flutter_gemini.dart';

void main() {
  Gemini.init(apiKey: ApiKey.geminiApiKey, enableDebugging: true);
  runApp(const MyApp());
}
